...
export function selectHoldBucket(value, immediate) {
  return {
    type: 's/SELECT_HOLD_BUCKET',
    value,
    immediate,
  };
}
...
export function sendChatReaction(messageId, emoji, channelId) {
  return {
    type: 's/REQ_CHAT_REACTION',
    messageId,
    emoji,
    channelId,
  };
...
export function receiveTypingUpdate(users, channelId) {
  return {
    type: 's/REC_TYPING_UPDATE',
    users,
    channelId,
  };
}
...
export function setChatHistoryLength(length) {
  return {
    type: 's/SET_CHAT_HISTORY_LENGTH',
    length,
  };
}


export function setBrushSize(size, userId, userlvl) {
  return {
...
export function setBrushUnlocked(value) {
  return {
    type: 's/SET_BRUSH_UNLOCKED',
    value,
  };
}
...
export function setBrushShape(shape) {
  return {
    type: 's/SET_BRUSH_SHAPE',
    shape,
  };
}

export function setCustomBrushShape(shape) {
  return {
    type: 's/SET_CUSTOM_BRUSH_SHAPE',
    shape,
  };
}

export const toggleLegacyZoom = () => ({
  type: 's/TGL_LEGACY_ZOOM',
});
