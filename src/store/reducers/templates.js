...
const initialState = {
  ...
  oOpacity: 40,
  oSmallPxls: true,
  // Custom key bindings for shift/spacebar
  keyBindings: {
    leftShift: 'OVERLAY',  // OVERLAY, HISTORY, PENCIL
    rightShift: 'HISTORY', // OVERLAY, HISTORY, PENCIL
    spacebar: 'PENCIL',    // OVERLAY, HISTORY, PENCIL
  },
  /*
   * [{
   *   enabled,
