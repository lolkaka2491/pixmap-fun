...
const RegUser = sequelize.define('User', {
  ...
  // Add bio field
  bio: {
    type: `${DataTypes.CHAR(400)} CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci`,
    allowNull: true,
  },
  ...
  // // VIP settings (stored as JSON)
  // vipSettings: {
  //   type: DataTypes.TEXT,
  //   allowNull: true,
  //   get() {
  //     const rawValue = this.getDataValue('vipSettings');
  //     return rawValue ? JSON.parse(rawValue) : {
  //       rainbowName: false,
  //       rainbowText: false,
  //       customPixelColor: '#FF0000',
  //       chatBadgeEnabled: true,
  //     };
  //   },
  //   set(value) {
  //     this.setDataValue('vipSettings', JSON.stringify(value));
  //   },
  // },
  ...
  getterMethods: {
    ...
    //   if (!this.vipExpiry) return true; // No expiry = permanent VIP
