...
import { notFoundRateLimit } from '../middleware/rateLimitMiddleware';
...
// Add specific route for avatars
router.use('/public/avatars', express.static('/root/pixelplanet/dist/avatars', {
  maxAge: 12 * MONTH,
}));
