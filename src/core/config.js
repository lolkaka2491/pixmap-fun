...
export const USE_CFCAPTCHA = parseInt(process.env.USE_CFCAPTCHA, 10) || 0;
export const CF_TURNSTILE_SITE_KEY = process.env.CF_TURNSTILE_SITE_KEY || '';
...
/** Discord Webhook for **Moderation** Logging */
export const DISCORD_HOOK_MLOG = process.env.DISCORD_HOOK_MLOG || false;

/** Discord Webhook for **Server** Logging */
export const DISCORD_HOOK_SLOG = process.env.DISCORD_HOOK_SLOG || false;

/** Discord Webhook Logging toggle. True = enabled; False = disabled */
export const DISCORD_LOGGING_ENABLED = process.env.DISCORD_LOGGING_ENABLED || '';

export const CANVAS_TOKEN_SECRET = process.env.CANVAS_TOKEN_SECRET || 'change-me-canvas-secret';
export const CANVAS_TOKEN_TTL_SECONDS = parseInt(process.env.CANVAS_TOKEN_TTL_SECONDS, 10) || 60;