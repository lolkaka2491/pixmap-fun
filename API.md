...
- USE_CFCAPTCHA: set to "1" to enable Cloudflare Turnstile instead of the built-in image captcha.
- CF_TURNSTILE_SITE_KEY: your Cloudflare Turnstile site key (exposed to client).
- CF_TURNSTILE_SECRET_KEY: your Cloudflare Turnstile secret key (kept on server).
